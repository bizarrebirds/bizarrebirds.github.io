    ...
    return (
        <FolderPage className="flex flex-col sm:flex-row">
            ...
            <div className="flex-1 mt-12 sm:mt-0 sm:mx-4 sm:px-4 sm:py-4 sm:bg-white">
                <Description>I offer the following:</Description>
                <ul>
                    <li><Description>Initial Info Call (free)</Description></li>
                    <li><Description>Trial Class ($50/hr)</Description></li>
                    <li><Description>1:1 Tutoring Sessions ($100/hr)</Description></li>
                    <li><Description>Small Group Tutoring Sessions (case-by-case)</Description></li>
                </ul>
                ...
                <Subheading>Initial Info Call</Subheading>
                <Description>
                ...
                <Subheading>Trial Class</Subheading>
                ...
                <Subheading>1:1 Tutoring Sessions</Subheading>
